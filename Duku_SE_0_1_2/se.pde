class Searchengine {    
  PImage dukulogo= loadImage("https://i.imgur.com/Z74zWZT.png");
  PImage luckybtn=loadImage("https://i.imgur.com/apkrzTU.png");
  PImage closebtns=loadImage("https://i.imgur.com/ATLEW4F.png");
  float dlX=(width-200)/2;
  float dlY=height/4;
  float lbX=(width-150)/2;
  float lbY=height-height/3;
  float cbX=width-90;
  float cbY=0;
  ...
  void sedraw() {
    ...
    image(dukulogo, dlX, dlY, 200, 100);
    image(luckybtn,lbX,lbY,150,50);
    image(closebtns,cbX,cbY,90,30);
...
/*The following code is not mine. The author is @calsign (William Smith) and the source is 
https://forum.processing.org/two/discussion/comment/48966/#Comment_48966*/
